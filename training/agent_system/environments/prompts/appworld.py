...
Now it's your turn to generate code to solve the task.
You should first reason step-by-step about which APIs to call, what arguments to use, and how to build your code block to complete the task. This reasoning process MUST be enclosed within <think> </think> tags. But don't think too long.
Once you've finished your reasoning, you present the solution code body within <code> </code> tags.
"""
