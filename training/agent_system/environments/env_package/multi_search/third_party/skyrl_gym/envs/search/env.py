from agent_system.environments.env_package.multi_search.third_party.skyrl_gym.envs.base_text_env import BaseTextEnv, BaseTextEnvStepOutput, ConversationType
from typing import Any
from agent_system.environments.env_package.multi_search.third_party.skyrl_gym.envs.search.utils import compute_score_em
from agent_system.environments.env_package.multi_search.third_party.skyrl_gym.tools import SearchToolGroup
import re
...
class SearchEnv(BaseTextEnv):
    ...
    def _get_reward(self, action: str, done: bool) -> float:
        if done:
            ...
            return compute_score_em(chat_history_str, self.ground_truth)
        else:
