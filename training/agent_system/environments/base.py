...
class EnvironmentManagerBase:
    ...
    def extract_action(self, text_action: str) -> str:
        ...
        Parameters:
        - text_action (str): The text action to extract from.
    ...
    def equal_action(self, action1: str, action2: str) -> bool:
        ...
        Parameters:
        - action1 (str): The first action.
        - action2 (str): The second action.
        
        Returns:
        - is_equal (bool): True if the actions are equal, False otherwise.
        """
        return self.extract_action(action1) == self.extract_action(action2)