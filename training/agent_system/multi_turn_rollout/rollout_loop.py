...
class TrajectoryCollector:
    ...
    def vanilla_multi_turn_loop(
        ...
        progress_bar = tqdm(range(self.config.env.max_steps), desc="Trajectory Collection", leave=False)
        for _step in progress_bar:
            ...
            if is_done.all():
                progress_bar.set_description("All environments completed")
                break
