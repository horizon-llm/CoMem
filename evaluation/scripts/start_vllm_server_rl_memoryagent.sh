...
MODEL="${MODEL:-BytedTsinghua-SIA/RL-MemoryAgent-7B}"
DEVICES=${DEVICES:-"0,1,2,3,4,5,6,7"}  # Override like DEVICES="0,1,2,3"
PORT=${PORT:-9002}  # Override like PORT=9002
MAX_CONTEXT_LEN=${MAX_CONTEXT_LEN:-32768}  # Override like MAX_CONTEXT_LEN=131072
