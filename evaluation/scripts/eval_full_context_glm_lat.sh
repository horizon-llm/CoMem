...
EXP_NAME="full-context-glm-8gpu-eval-t100-lat"
...
PYTHON="/root/miniconda3/envs/r2e-gym/bin/python" DEVICES="0,1,2,3,4,5,6,7" nohup bash scripts/start_vllm_server_glm.sh > "vllm_server.out" 2>&1 &
VLLM_PID=$!
