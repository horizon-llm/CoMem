...
EXP_NAME="full-context-qmax-eval-t100"
...
KV_OFFLOADING_SIZE=500 PYTHON="/root/miniconda3/envs/r2e-gym/bin/python" DEVICES="0,1,2,3,4,5,6,7" nohup bash scripts/start_vllm_server_qwencoder_max_cpu.sh > "vllm_server_qmax.out" 2>&1 &
VLLM_PID=$!
