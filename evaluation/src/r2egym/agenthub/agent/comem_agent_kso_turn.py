...
class COMEMAgent:
    ...
    def prepare_history_to_append(self, append_steps) -> List[Dict[str, str]]:
        ...
        for idx, step in enumerate(append_steps):
            ...
            observation = step.observation
            history_to_append.append({"role": "assistant", "content": assistant_message})
            history_to_append.append({"role": "user", "content": observation})
    ...
    def _prepare_messages_for_query(self, problem_statement: str, summary: str, history_to_append: List[Dict[str, str]], stepcount_message: str) -> List[Dict[str, str]]:
        if summary.strip() != "":
            ...
            messages.extend(history_to_append)
        else:
    ...
    def run(
        ...
        while not done:
            ...
            trajectory_step = TrajectoryStep(
                ...
                query_prompt=json.dumps(messages, default=str),
                history_to_append="",
                assistant_message="",
                # tokens
