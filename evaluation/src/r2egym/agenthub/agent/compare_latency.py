"""
take the existing inference results from context and then compare with comem
"""
import os
import re
import copy
...
from r2egym.agenthub.trajectory import Trajectory as TrajectoryBase
...
class COMEMAgent:
    ...
    def __init__(self, name: str, args: AgentArgs, logger=None):
        ...
        self.max_retries = self.other_args.get("max_retries", 1)
    ...
    def prepare_history_message(self, reference_trajectory, step_count, retain_most_turns=1) -> str:
        ...
        """
        trajectory_steps = reference_trajectory.trajectory_steps[:step_count]
    ...
    def run(
        ...
        scaffold: str = "r2egym",
        reference_trajectory: TrajectoryBase = None,
    ):
        ...
        system_prompt = reference_trajectory.system_prompt
        user_prompt = reference_trajectory.initial_user_prompt
        ...
        while not done:
            ...
            # acquire environment feedback from reference trajectory
            obs, done, info = reference_trajectory.trajectory_steps[step_count].observation, reference_trajectory.trajectory_steps[step_count].done, reference_trajectory.trajectory_steps[step_count].info
