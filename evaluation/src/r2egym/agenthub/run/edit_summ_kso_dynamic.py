...
from r2egym.agenthub.agent.comem_agent_kso_dynamic import AgentArgs
from r2egym.agenthub.agent.comem_agent_kso_dynamic import COMEMAgent as Agent
...
def runagent(
    ...
    retain_most_turns_after_limit: int = 1,
    ...
    agent_args.retain_most_turns_after_limit = retain_most_turns_after_limit
    ...
    with concurrent.futures.ProcessPoolExecutor(max_workers=max_workers) as executor:
        ...
        future_to_image = {
            executor.submit(
                ...
                retain_most_turns_after_limit=retain_most_turns_after_limit,
